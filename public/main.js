...
(function() {
    ...
    function findWinners(stat, roundNum, matchups) {
        ...
        for(let i=0; i<matchups.length; i++) {
            ...
            let url = siteUrl+"?mode=winner&stat="+stat+"&name1="+name1+"&name2="+name2;
            fetch(url)
                .then(checkStatus)
    ...
    function checkAccuracy() {
        ...
        fetch(url)
            ...
            .then(function(responseText) {
                ...
                //Skip first 32 matchups; they are the initial matchups of round 0
                ...
                percentCorrect.innerHTML = ((matchupsCorrect / SLOT_AMOUNT) * 100).toFixed(2);
            })
            .catch(function(error) {
                displayError(error);
        });
